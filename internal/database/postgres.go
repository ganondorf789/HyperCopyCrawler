...
func NewPostgres(cfg config.PostgresConfig) (*gorm.DB, error) {
	...
	// 自动迁移表结构
	if err := db.AutoMigrate(&model.Trader{}, &model.TraderPerformance{}, &model.TraderAccountValue{}, &model.TraderPnlHistory{}, &model.TraderFill{}, &model.ProxyPool{}, &model.CompletedTrade{}); err != nil {
